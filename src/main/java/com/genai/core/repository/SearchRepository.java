...
public interface SearchRepository {
     ...
     * @return 키워드 검색 결과 목록
     */
    <T extends DocumentEntity> List<Search<T>> keywordSearch(CollectionType collectionType, String query, int topK, String sessionId, List<String> alias);
     ...
     * @return 벡터 검색 결과 목록
     */
    <T extends DocumentEntity> List<Search<T>> vectorSearch(CollectionType collectionType, String query, int topK, List<String> alias);
